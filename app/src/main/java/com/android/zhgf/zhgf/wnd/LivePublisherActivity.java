...
public class LivePublisherActivity extends Activity implements OnClickListener, LivePublishDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PUBLISH_REAL_URL = getIntent().getStringExtra("rtmpURL");
        Log.e(TAG, "onCreate: PUBLISH_REAL_URL"+PUBLISH_REAL_URL);
        if (PUBLISH_REAL_URL==""){
            Log.e(TAG, "onCreate: PUBLISH_REAL_URL"+"为空" );
        }
    ...
    void SendOpenVideoCommand(final int video_open){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String HttpURL = getIntent().getStringExtra("isOpenVideoURL");
                String params = getIntent().getStringExtra("isOpenVideoParam");
