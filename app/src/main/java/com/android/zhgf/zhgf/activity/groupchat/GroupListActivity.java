...
import com.android.zhgf.zhgf.activity.chat.ChatActivity;
import com.android.zhgf.zhgf.adapter.GroupListAdapter;
import com.android.zhgf.zhgf.service.ConnectionService;
...
public class GroupListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multiUserChatManager = XMPPUtil.getMultiChatManager();
        user = PreferencesUtils.getString(CommonField.USER_NAME);
        //bindService();
        getData();
            ...
            //if (supports) {
                ...
                groupListAdapter.setGroupListClickListener(new GroupListAdapter.GroupListClickListener() {
                    ...
                    public void onItemClick(int position) {
                        joinChatRoom(roomList.get(position).getJid(), user, "");
                        if (!isError) {
                            Intent intent = new Intent();
                            ...
                            intent.putExtra(GroupChatActivity.FROM_ID,roomList.get(position).getJid());
        ...
        btnJoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!TextUtils.isEmpty(edtPwd.getText().toString())) {
                    joinChatRoom(groupName, user, edtPwd.getText().toString());
                    //若加入聊天室未出错
                    if (!isError) {
                        Intent intent = new Intent();
                        intent.setClass(GroupListActivity.this, GroupChatActivity.class);
                        ...
                        intent.putExtra(GroupChatActivity.FROM_ID, groupName);
                        startActivity(intent);
                    }
                    dialog.dismiss();
                }
