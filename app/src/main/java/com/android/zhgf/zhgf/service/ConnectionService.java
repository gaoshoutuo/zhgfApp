...
public class ConnectionService extends Service {
    ...
    public static final String SERVER_NAME = "192.168.10.104";//主机名
    public static final String SERVER_IP = "192.168.10.104";//ip
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    user = dbHelper.SetUser(userName + "@192.168.10.104", password);//插入数据库
