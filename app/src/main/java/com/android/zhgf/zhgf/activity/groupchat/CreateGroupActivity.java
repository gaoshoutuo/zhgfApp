...
public class CreateGroupActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   /* private void bindService() {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_create_group:
                ...
                MultiUserChat chatRoom = createChatRoom(edtGroupName.getText().toString(), user, edtGroupPwd.getText().toString());
                if (chatRoom != null) {
                    setResult(RESULT_OK);
                    finish();
                }
    ...
    public MultiUserChat createChatRoom(String roomName, String nickName, String password) {
        ...
        try {
            // 创建一个MultiUserChat
            muc = multiUserChatManager.getMultiUserChat(roomName + "@conference." + XMPPUtil.getServiceName());
            // 创建聊天室
            ...
            if (isCreated) {
                ...
                owners.add(ObjectHolder.XMPP_ID);// 用户JID
